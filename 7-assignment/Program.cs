...
namespace procedural_vs_oop
{
    class Program
    {
        //procedural programming is quite easier for beginners with non-OOP
        // programming language experience. But it looks like a massi table with 
        //full of stuffs you use in your daily work. While OOP is  quite clean and easy to read.
        // It looks like an office with shelfs- full of properli arranged stuffs and 
        // and clean table with only some essential stuffs like PC, pen,pencil etc.
        // For example, following code is from my first project is much more procedural
        //type. we could event parse the loops to some other static method of another 
        // class. No it is difficult for someone else to read the code.
